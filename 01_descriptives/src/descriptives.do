...
cd "/Users/justinfallo/Downloads/uni/eth/center for law economics and data science/projects/religious_sermons/code/01_descriptives/"
...
save "output/state_coverage.dta", replace
...
merge 1:m state using "output/state_coverage.dta"
drop if _merge == 1
